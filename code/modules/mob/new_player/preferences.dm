datum/preferences
	...
	proc/update_preview_icon()
		...
		src.preview_icon = new /icon('icons/mob/human.dmi', "body_[g]_s")
		...
		if (src.underwear > 0)
			src.preview_icon.Blend(new /icon('icons/mob/human.dmi', "underwear[src.underwear]_[g]_s"), ICON_OVERLAY)

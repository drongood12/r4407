...
*/
				...
				if(T.airN)
					O.overlays += image('icons/misc/icons/misc/mark.dmi', T.airdir==1?"up":"fup")

				if(T.airS)
					O.overlays += image('icons/misc/icons/misc/mark.dmi', T.airdir==2?"dn":"fdn")

				if(T.airW)
					O.overlays += image('icons/misc/icons/misc/mark.dmi', T.airdir==8?"lf":"flf")

				if(T.airE)
					O.overlays += image('icons/misc/icons/misc/mark.dmi', T.airdir==4?"rt":"frt")


				if(T.condN)
					O.overlays += image('icons/misc/icons/misc/mark.dmi', T.condN == 1?"yup":"rup")

				if(T.condS)
					O.overlays += image('icons/misc/icons/misc/mark.dmi', T.condS == 1?"ydn":"rdn")

				if(T.condE)
					O.overlays += image('icons/misc/icons/misc/mark.dmi', T.condE == 1?"yrt":"rrt")

				if(T.condW)
					O.overlays += image('icons/misc/icons/misc/mark.dmi', T.condW == 1?"ylf":"rlf")
	else
		alert("Debugging off")
		return
...
/proc/numbericon(var/tn as text,var/s = 0)
	if(Debug)
		var/image/I = image('icons/misc/icons/misc/mark.dmi', "blank")
		...
		for(var/d = 1 to lentext(tn))
			...
			var/image/ID = image('icons/misc/icons/misc/mark.dmi', char)
